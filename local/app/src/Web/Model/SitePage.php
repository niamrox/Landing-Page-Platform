  ...
  protected $table = 'site_pages';
	...
	public function __construct(array $attributes = array()) {
        ...
        static::creating(function($item)
        {
            ...
            //\App\Controller\LogController::Log(\Auth::user(), 'App Page', 'created app page (' . $item->name . ')', 'app');
        });

        static::updating(function($item)
        {
			$item->updated_by = \Auth::user()->id;
            //\App\Controller\LogController::Log(\Auth::user(), 'App Page', 'updated app page (' . $item->name . ')', 'app');
        });
	}
	...
	{
		return $this->belongsTo('Web\Model\Site');
	}

	public function sitePageType()
	{
		return $this->hasOne('Web\Model\SitePageType');
	}
