...
return array(
    ...
    'alerts' => array(
        'account_created' => 'Your account has been successfully created. Please click the confirmation link sent to your email address.',
        ...
        'not_confirmed' => 'Your account is not active. Please check your mail or contact your administrator.',
    ...
    'email' => array(
        ...
        'account_created' => array(
            ...
            'greetings' => 'Hello :name',
            'body' => 'An account has been created for you. Please login by clicking the link below.',
            'login_credentials' => 'You can login with the following credentials:<br><br>Username: :username or :email<br>Password: :password',
            'farewell' => 'Regards',
        ),
    ),
